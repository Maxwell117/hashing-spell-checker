...
private:
 ...
 public:
  ...
  //starts all counters at 0
  explicit HashTable(size_t size = 101):array_(NextPrime(size))
  { 
  current_size_=0;//start with 0 elements 
  MakeEmpty(); 
  //flag=false;
  collision_counter=0;
  }
...
/////////////////////////////////////////////////////////////
  ...
  {
  return "I will run the quadratic Hashing code";
  }
...
//    
 private:        
  ...
  //modified to handle quadratic
  size_t FindPos(const HashedObj & x) const {//include probes?
    size_t offset = 1;//starts at 1
    ...
    while (array_[current_pos].info_ != EMPTY &&
	   array_[current_pos].element_ != x) {
	   //collision_counter++;//keep track of collisions
      current_pos += offset;  //Compute ith probe.
      offset += 2;            //increment by 2 since its quadratic    
      //probes++;
  ...
  //modified to expand table_size when full
  void Rehash() 
  {
    ...
    //had to look up this command http://www.cplusplus.com/reference/algorithm/copy_if/
...
//helper functions for Enums,most not used
//////////////////////////////////////////////////
